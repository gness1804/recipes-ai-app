...
class Recipe(BaseModel):
    id: typing.Optional[str] = Field(default=None, description='The unique identifier of the recipe. This is the slug of the recipe. This should be the same as the _id field in the vector DB schema. This should be a lowercase string with hyphens between words. This should be derived from the title of the recipe, not the contents.\nFor example, "caribbean-chicken" for the recipe "Caribbean Chicken".')
