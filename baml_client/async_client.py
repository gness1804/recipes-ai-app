...
class BamlAsyncClient:
    ...
    async def ExtractRecipe(self, recipe: str,
        baml_options: BamlCallOptions = {},
    ) -> types.Recipe:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractRecipe(recipe=recipe,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractRecipe", args={
                "recipe": recipe,
            })
    ...
    async def ExtractRecipeFromImage(self, image: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(types.Recipe, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> types.Recipe:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractRecipeFromImages(images=images,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractRecipeFromImages", args={
                "images": images,
            })
            return typing.cast(types.Recipe, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractRecipe(self, recipe: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Recipe, types.Recipe]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractRecipe", args={
            "recipe": recipe,
        })
    ...
    def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Recipe, types.Recipe]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractRecipeFromImages", args={
            "images": images,
        })
        return baml_py.BamlStream[stream_types.Recipe, types.Recipe](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractRecipeFromImages", args={
            "images": images,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
