...
class BamlSyncClient:
    ...
    def ExtractRecipe(self, recipe: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractRecipe", args={
                "recipe": recipe,
            })
    ...
    def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractRecipeFromImages", args={
                "images": images,
            })
            return typing.cast(types.Recipe, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractRecipe(self, recipe: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractRecipe", args={
            "recipe": recipe,
        })
    ...
    def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractRecipeFromImages", args={
            "images": images,
        })
        return baml_py.BamlSyncStream[stream_types.Recipe, types.Recipe](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractRecipeFromImages(self, images: typing.List[baml_py.Image],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractRecipeFromImages", args={
            "images": images,
        }, mode="request")
        return __result__
    def ExtractResume(self, resume: str,
