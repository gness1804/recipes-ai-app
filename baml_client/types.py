...
class Recipe(BaseModel):
    id: str = Field(description='The unique identifier of the recipe. This is the slug of the recipe. This should be the same as the _id field in the vector DB schema.\nFor example, "caribbean-chicken" for the recipe "Caribbean Chicken".')
